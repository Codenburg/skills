...
# Core Concepts — Worked Examples

The patterns below are the foundational building blocks referenced from `SKILL.md`. Read them when the Decision Gates table points to a construct and you need a full code example.
